    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { MainTitle(title = "EDIT CRONO APP") },
...
fun ContentEditView(
    ...
    LaunchedEffect(Unit) { //para que se ejecute por sí sólo
    ...
    Column (
        ...
        DisposableEffect(Unit) { //Con esto nos aseguramos que esta porción de código se ejecute siempre
            onDispose {
